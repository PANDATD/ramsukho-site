...
alt_text_mapping = {
    ...
    "Family-suite\FS-1.webp": "Spacious bedroom in Ramsukh Resort's family suite with a king-size bed, antique chairs, and warm lighting.",
    "Family-suite\FS-2.webp": "Cozy living area of the family suite in Ramsukh Resort, featuring comfortable seating, a television, and a window view.",
    "Family-suite\FD.webp": "Elegant bedroom in Ramsukh Resort with a large window overlooking lush greenery, featuring a cozy bed and warm lighting fixtures.",
    "Family-suite\FP-1.webp": "Cozy bedroom in Ramsukh Resort with a balcony, natural lighting, and a view of the surrounding greenery.",
    "Family-suite\FP-2.webp": "Spacious bedroom and living area in Ramsukh Resort with a comfortable sofa and large windows offering scenic views.",
    "Garden-suite\GD-1.webp": "Garden suite bedroom at Ramsukh Resort with a balcony, flat-screen TV, and stylish decor with a large mirror.",
    "Garden-suite\GD-2.webp": "Garden suite bedroom and balcony view at Ramsukh Resort with outdoor seating and decorative wall art.",
    "Garden-suite\GS-1.webp": "Spacious bedroom in the garden suite at Ramsukh Resort with an intricately designed dresser, mirror, and vibrant wall art.",
    "Garden-suite\GS-2.webp": "Cozy living area in the garden suite at Ramsukh Resort with a striped sofa, television, and kitchenette.",
    "Garden-suite\GS-3.webp": "Private balcony in the garden suite at Ramsukh Resort featuring outdoor seating and a view of lush greenery.",
    "Terrace-suite\TBS-1.webp": "Elegant bedroom in the terrace suite at Ramsukh Resort featuring soft lighting, ceiling fan, and attached bathroom with forest views.",
    "Terrace-suite\TBS-2.webp": "Cozy bedroom in the terrace suite at Ramsukh Resort with a large window offering serene views of lush greenery.",
    "Terrace-suite\TBS-3.webp": "Spacious living and dining area in the terrace suite at Ramsukh Resort, decorated with artwork and modern furnishings.",
    "Terrace-suite\TBS-4.webp": "Living room in the terrace suite at Ramsukh Resort with a balcony overlooking scenic landscapes and framed photography on the walls.",
    "Valley-suite\VS-1.webp": "Cozy bedroom in the Valley Suite at Ramsukh Resort with a balcony offering scenic valley views and vibrant wall art.",
    "Valley-suite\VS-2.webp": "Spacious living area in the Valley Suite at Ramsukh Resort with elegant decor, chandelier, and forest-facing windows.",
    "Valley-suite\VS-3.webp": "Balcony in the Valley Suite at Ramsukh Resort with wicker furniture, offering expansive views of the surrounding landscape.",
    "Pool\1-Pool.webp": "Outdoor pool area at Ramsukh Resort with poolside seating and umbrellas, offering a scenic view of the surrounding hills.",
    "Disco\2-Disco-Theque.webp": "Stylish disco room at Ramsukh Resort with leather seating, colorful lighting, and wooden decor.",
    "Play Area\3-Outdoor-Play Area.webp": "Outdoor children’s play area at Ramsukh Resort with a slide, climbing frames, and shaded trees.",
    "Play Room\4-Children-Play-Room.webp": "Indoor children's playroom at Ramsukh Resort, featuring slides, toys, and colorful activity areas.",
    "Adventure\5-Night-Ride.webp": "Night jeep ride adventure at Ramsukh Resort, offering an exciting experience through forested roads.",
    "Fitness\6-Outdoor-fitness zone.webp": "Outdoor fitness zone at Ramsukh Resort, surrounded by greenery, featuring exercise equipment in a natural setting.",
    "Trek\7-Jungle-Trek.webp": "Group of hikers on a jungle trek at Ramsukh Resort, exploring the rocky terrain and dense forest.",
    "Spa\8-Spa.webp": "Serene spa room at Ramsukh Resort with a massage table and a rose petal-filled hot tub for relaxation.",
    "1-Ramsukh-Forest-canopy\1-Ramsukh-Forest-canopy.webp": "Outdoor dining area under forest canopy at Ramsukh Resort, Mahabaleshwar.",
    "2-Red-black-hall\2-Red-black-hall.webp": "Elegant indoor banquet hall with round tables at Ramsukh Resort, Mahabaleshwar.",
    "3-Main-conference-hall\3-Main-conference-hall.webp": "Spacious conference hall with U-shaped seating arrangement at Ramsukh Resort, Mahabaleshwar.",
